...
import type { ForgotPasswordResponse, ForgotPasswordRequest } from "~~/server/types/auth";

export default defineEventHandler(async (event): Promise<ApiResponse<ForgotPasswordResponse>> => {
  try {
    // Get request body
