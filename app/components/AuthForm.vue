<template>
    <div class="auth-form">
        ...
        <button class="social-button instagram" @click="loginWithInstagram">
...
export default defineComponent({
    ...
    methods: {
      ...
      loginWithGoogle() {
        // Emit an event for Facebook login
        this.$emit("social-login", "google");
      },
      loginWithInstagram() {
        // Emit an event for Instagram login
        this.$emit("social-login", "instagram");
      },
    },
    });
    </script>
